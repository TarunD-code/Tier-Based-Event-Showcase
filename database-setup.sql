...
-- Note: This is a simplified policy for demo purposes
-- In production, you'd want to integrate with Clerk user metadata
...
-- Insert sample events (2 per tier as required)
